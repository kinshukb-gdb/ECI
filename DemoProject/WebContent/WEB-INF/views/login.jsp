										...
										<div class="col-sm-12 col-md-10  col-md-offset-1 ">
											<div class="form-group">
												<div class="input-group">
													...
													</span> <sf:input class="form-control" placeholder="Username" id="Email"
														path="email"/>
											...
											<div class="form-group">
												<div class="input-group">
													...
													</span> <sf:input class="form-control" placeholder="Password" id="Password" type="password"
														path="password"/>
												</div>
											</div>
											<div class="form-group">
												...
												<a href="forgot"
													class="btn btn-link pull-right forgot-link">Forgot
													Password?</a>
											</div>
